...
<body>
        ...
        <div class="detail-container">
            <div class="main-content">
                ...
                <div class="description-section">
                    ...
                    <p class="description-text">{{ $reporte->descripcion }}</p>
                </div>
                ...
                <div class="images-section">
                    ...
                    <div class="image-container">
                        <img src="/storage/{{ $reporte->imagen_problema }}" alt="Evidencia del problema" class="img-fluid">
                    </div>
                </div>
                @endif
                ...
                <div class="images-section">
                    ...
                    <div class="image-container">
                        <img src="/storage/{{ $reporte->imagen_solucion }}" alt="Evidencia de la solución" class="img-fluid">
                    </div>
                </div>
                @endif

                @if($reporte->usuariosApoyo && $reporte->usuariosApoyo->count() > 0)
                ...
                <div class="info-card">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">{{ $reporte->usuario->nombre }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">{{ $reporte->created_at->format('d/m/Y H:i') }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">{{ $reporte->direccion }}</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">{{ $reporte->usuariosApoyo->count() }} personas</div>
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-content">
                            ...
                            <div class="info-value">{{ $reporte->admin->nombre }}</div>
                        </div>
                    </div>
                    @endif
                </div>
            ...
            <form method="POST" action="/reporte/actualizar/{{ $reporte->id }}" enctype="multipart/form-data">
                ...
                <div class="form-floating">
                    <select class="form-select" name="estado" id="estado">
                        ...
                        <option value="finalizado" {{ $reporte->estado == 'finalizado' ? 'selected' : '' }}>Finalizado</option>
                    </select>
                ...
                <div class="form-floating">
                    <textarea class="form-control" 
                              ...
                              style="height: 120px; resize: none;">{{ $reporte->mensaje_admin ?? '' }}</textarea>
    ...
    <script>
        ...
        marker.bindPopup('<b>{{ $reporte->categoria }}</b><br>{{ $reporte->direccion }}').openPopup();
    </script>
</body>
</html>