        ...
        <div class="notifications-container">
            ...
            <div class="notifications-stats">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $notificaciones->where('created_at', '>=', now()->subDays(7))->count() }}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $notificaciones->where('created_at', '>=', now()->subDays(1))->count() }}</div>
                    <div class="stat-label">Hoy</div>
                </div>
            </div>

            <div class="notifications-list">
                @foreach($notificaciones as $index => $n)
                <div class="notification-card {{ $index % 3 == 0 ? 'info' : ($index % 3 == 1 ? 'warning' : 'success') }}">
                    <div class="notification-header">
                        <div class="notification-type {{ $index % 3 == 0 ? 'info' : ($index % 3 == 1 ? 'warning' : 'success') }}">
                            @if($index % 3 == 0)
                    ...
                    <div class="notification-actions">
                        <a href="/reporte/{{ $n->reporte_id }}" class="btn-view-report">
