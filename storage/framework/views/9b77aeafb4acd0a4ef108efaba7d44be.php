        ...
        <div class="admin-container">
            <div class="sidebar">
                <div class="stats-card">
                    ...
                    <div class="stats-grid">
                        <div class="stat-item">
                            <div class="stat-number"><?php echo e($reportes->count()); ?></div>
                            <div class="stat-label">Total de Reportes</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number"><?php echo e($reportes->where('estado', 'pendiente')->count()); ?></div>
                            <div class="stat-label">Pendientes</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number"><?php echo e($reportes->where('estado', 'en_proceso')->count()); ?></div>
                            <div class="stat-label">En Proceso</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number"><?php echo e($reportes->where('estado', 'finalizado')->count()); ?></div>
                            <div class="stat-label">Finalizados</div>
                        </div>
                    </div>
                </div>

                <?php if(Auth::user()->rol == 'superadmin'): ?>
            ...
            <div class="main-content">
                ...
                <div class="reports-grid" id="reportsGrid">
                    ...
                    <div class="report-card <?php echo e($color); ?>" data-status="<?php echo e($r->estado); ?>">
                        <div class="report-header">
                            <div class="report-meta">
                                <div class="category-badge">
                                    <?php switch($r->categoria):
                                        case ('areas_verdes'): ?>
                                        ...
                                        <?php case ('alumbrado'): ?>
                                            ...
                                            <?php break; ?>
                                        <?php default: ?>
                                            <?php echo e($r->categoria); ?>

                                    <?php endswitch; ?>
                                </div>
                                <div class="priority-badge <?php echo e($priorityClass); ?>">
                                    <?php echo e($nivel); ?>
                            ...
                            <div class="report-author">
                                <div class="author-avatar">
                                    <?php echo e(substr($r->usuario->nombre, 0, 1)); ?>

                                </div>
                                <div class="author-info">
                                    <p class="author-name"><?php echo e($r->usuario->nombre); ?></p>
                                    <p class="supports-count">
                                        <i class="bi bi-hand-thumbs-up-fill me-1"></i>
                                        <?php echo e($apoyos); ?> apoyos
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="report-info">
                            <div class="report-status status-<?php echo e(str_replace('_', '-', $r->estado)); ?>">
                                <?php switch($r->estado):
                                    case ('pendiente'): ?>
                            ...
                            <div class="report-actions">
                                <a href="/reporte/<?php echo e($r->id); ?>" class="btn-view">
...
</html><?php /**PATH C:\Users\52722\homeLY\resources\views/dashboard_admin.blade.php ENDPATH**/ ?>