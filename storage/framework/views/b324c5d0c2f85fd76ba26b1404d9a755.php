    ...
    <section class="reports-section">
        <div class="section-header">
            ...
            <div class="badge bg-primary">
                <?php echo e($reportes->count()); ?> reportes
            </div>
        </div>
            ...
            <div class="report-card">
                <div class="report-header">
                    ...
                    <div class="report-meta">
                        <span><i class="bi bi-calendar3 me-1"></i> <?php echo e($r->created_at->format('d/m/Y')); ?></span>
                        <span class="report-status"><?php echo e($r->estado); ?></span>
                    </div>
                </div>
                ...
                <div class="report-body">
                    <div class="report-author">
                        ...
                        <div class="author-info">
                            ...
                            <p class="supports-count">
                                ...
                                <?php echo e($r->apoyos->count()); ?> apoyos
                            </p>
                        </div>
                        <?php if($r->usuario_id != auth()->id()): ?>
                            <?php if($yaApoyo == 0): ?>
                                <a href="/reporte/apoyar/<?php echo e($r->id); ?>" class="support-btn">
                    ...
                    <div class="report-actions">
                        <a href="/reporte/<?php echo e($r->id); ?>" class="btn-action btn-view">
                            <i class="bi bi-eye-fill"></i>
                            Ver detalles
                        </a>
                        <?php if($r->usuario_id == auth()->id()): ?>
                            <a href="/reporte/eliminar/<?php echo e($r->id); ?>" 
...
<?php /**PATH C:\Users\52722\homeLY\resources\views/dashboard_residente.blade.php ENDPATH**/ ?>