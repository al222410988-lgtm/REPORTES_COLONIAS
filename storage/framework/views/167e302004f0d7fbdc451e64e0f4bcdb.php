...
<body>
    ...
    <div class="container">
        <div class="requests-container">
            ...
            <?php if($usuarios && $usuarios->count() > 0): ?>
            <div class="stats-overview">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number"><?php echo e($usuarios->where('created_at', '>=', now()->subDays(7))->count()); ?></div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-number"><?php echo e($usuarios->where('created_at', '>=', now()->subDays(1))->count()); ?></div>
            ...
            <div class="requests-grid">
                ...
                <div class="request-card pending">
                    <div class="request-header">
                        ...
                        <div class="user-info">
                            <div class="user-avatar">
                                <?php echo e(substr($u->nombre, 0, 1)); ?>

                            </div>
                            <div class="user-details">
                                <p class="user-name"><?php echo e($u->nombre); ?></p>
                    ...
                    <div class="request-actions">
                        <a href="/admin/aprobar/<?php echo e($u->id); ?>" class="btn-approve">
                            <i class="bi bi-check-circle-fill me-2"></i>
                            Aprobar Solicitud
                        </a>
                        
                        <a href="/admin/rechazar/<?php echo e($u->id); ?>" class="btn-reject" 
