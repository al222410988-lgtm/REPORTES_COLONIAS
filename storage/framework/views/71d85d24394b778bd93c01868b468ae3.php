    ...
    <div class="profile-container">
        ...
        <div class="profile-info-section">
            <div class="profile-header">
                ...
                <h1 class="profile-name"><?php echo e(auth()->user()->nombre); ?></h1>
                <div class="profile-role">
                    <?php if(auth()->user()->rol == 'admin'): ?>
                        <i class="bi bi-shield-fill me-1"></i>Administrador
                    <?php elseif(auth()->user()->rol == 'superadmin'): ?>
            ...
            <div class="profile-stats">
                <div class="stat-item">
                    ...
                    <div class="stat-number"><?php echo e(auth()->user()->reportes->count() ?? 0); ?></div>
                ...
                <div class="stat-item">
                    ...
                    <div class="stat-number"><?php echo e(auth()->user()->apoyos->count() ?? 0); ?></div>
                ...
                <div class="stat-item">
                    ...
                    <div class="stat-number"><?php echo e(auth()->user()->created_at->format('d/m/Y')); ?></div>
                ...
                <div class="stat-item">
                    ...
                    <div class="stat-number"><?php echo e(auth()->user()->email); ?></div>
            ...
            <?php if($puedeActualizar): ?>
                <div class="update-restriction">
                    ...
                    <div class="update-restriction-text">
                        Podrás actualizar tus datos nuevamente el <strong><?php echo e($siguienteActualizacion->format('d/m/Y H:i')); ?></strong>
                    </div>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="profile-edit-section">
            ...
            <a href="<?php echo e(auth()->user()->rol == 'admin' || auth()->user()->rol == 'superadmin' ? '/admin/dashboard' : '/dashboard'); ?>" class="btn-back">
            ...
            <?php else: ?>
                <div class="update-restriction">
                    ...
                    <div class="update-restriction-text">
                        ...
                        Próxima actualización disponible: <strong><?php echo e($siguienteActualizacion->format('d/m/Y H:i')); ?></strong>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
<?php /**PATH C:\Users\52722\homeLY\resources\views/perfil.blade.php ENDPATH**/ ?>